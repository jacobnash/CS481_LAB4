...
test: elevator_part_3
	touch test1.txt
	rm test*
	./elevator_part_3 10 10	.1 .1 .1 12 0 
	./elevator_part_3 10 1 .1 .1 .1 12 0 >> test1.txt
	./elevator_part_3 10 10 .01 .1 .1 12 0 >> test2.txt 
	./elevator_part_3 10 10 .1 .01 .01 12 0 >> test3.txt
	./elevator_part_3 10 10 .05 .1 .1 12 0 >> test4.txt
	./elevator_part_3 10 10 .02 .2 .01 12 0 >> test5.txt
	./elevator_part_3 10 6 .02 .02 .02 12 0 >> test6.txt
	./elevator_part_3 100 25 .02 .2 .01 12 0 >> test7.txt
	./elevator_part_3 100 4 .01 .01 .01 12 0 >> test8.txt
